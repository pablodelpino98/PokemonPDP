...
<body>
    ...
    <h2>¿Qué tipo de carta quieres registrar?</h2>
        <form method="POST" action="../Insert/insert_real_pokemon.php">
            <button type="submit">Pokémon Real</button>
        </form><br>
        <form method="POST" action="../Insert/insert_real_partidario.php">
            <button type="submit">Partidario Real</button>
        </form><br>
        <form method="POST" action="../Insert/insert_real_objeto.php">
            <button type="submit">Objeto Real</button>
        </form>
    </div>
    <div class="back">
